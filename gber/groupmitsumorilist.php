...
<div data-role="page"><!-- WRAPPER -->
    ...
    $sql5 = "SELECT * FROM worklist WHERE groupno = $groupno AND status = 0 LIMIT 100";
    ...
    <div data-role="content"><!-- START OF CONTENT -->
        ...
        <p><a href="groupwarifurilist.php?groupno=<?php echo $groupno; ?>"
              rel="external">③作業割り振り・日報記入一覧に進む</a></p>
        </br>
        <p>※ 下に見積もり中の案件が表示されています。</p>
        <p>※ 各仕事をクリックし、仕事の割り振りに進むか、断るかを選択してください。</p>
        </br>
        <div id="jobs">
            <?php
            if (count($records5) == 0) {
