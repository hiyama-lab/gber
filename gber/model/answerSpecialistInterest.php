...
//興味の有無を登録
mysql_query("INSERT INTO workinterest (workid, userno, interest) VALUES ('" . $workdata['workid'] . "', '"
    . $workdata['workerno'] . "', '" . $workdata['interest'] . "')", $con)
...
$activitylog
    ...
    . $workdata['workerno'] . "', 'answerSpecialistInterest.php', '"
